...
function urlChanger() {
  ...
  document.getElementById("wfolink").innerHTML =
    `<b>URL:</b> <a href="https://weather.im/iembot-rss/room/${myid}chat.xml">https://weather.im/iembot-rss/room/${myid}chat.xml</a>`;
}
